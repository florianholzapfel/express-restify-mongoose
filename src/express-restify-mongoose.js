...
const restify = function (app, model, opts = {}) {
  ...
  app.get(uriItems, options.preMiddleware, prepareQuery, options.preRead, accessMiddleware, ops.getItems, prepareOutput)
  app.get(uriCount, options.preMiddleware, prepareQuery, options.preRead, accessMiddleware, ops.getCount, prepareOutput)
  app.get(uriItem, options.preMiddleware, prepareQuery, options.preRead, accessMiddleware, ops.getItem, prepareOutput)
  app.get(uriShallow, options.preMiddleware, prepareQuery, options.preRead, accessMiddleware, ops.getShallow, prepareOutput)

  app.post(uriItems, options.preMiddleware, prepareQuery, ensureContentType, options.preCreate, accessMiddleware, ops.createObject, prepareOutput)
  app.post(uriItem, options.preMiddleware, util.deprecate(prepareQuery, 'express-restify-mongoose: in a future major version, the POST method to update resources will be removed. Use PATCH instead.'), ensureContentType, options.findOneAndUpdate ? [] : filterAndFindById, options.preUpdate, accessMiddleware, ops.modifyObject, prepareOutput)

  app.put(uriItem, options.preMiddleware, util.deprecate(prepareQuery, 'express-restify-mongoose: in a future major version, the PUT method will replace rather than update a resource. Use PATCH instead.'), ensureContentType, options.findOneAndUpdate ? [] : filterAndFindById, options.preUpdate, accessMiddleware, ops.modifyObject, prepareOutput)
  app.patch(uriItem, options.preMiddleware, prepareQuery, ensureContentType, options.findOneAndUpdate ? [] : filterAndFindById, options.preUpdate, accessMiddleware, ops.modifyObject, prepareOutput)

  app.delete(uriItems, options.preMiddleware, prepareQuery, options.preDelete, ops.deleteItems, prepareOutput)
  app.delete(uriItem, options.preMiddleware, prepareQuery, options.findOneAndRemove ? [] : filterAndFindById, options.preDelete, ops.deleteItem, prepareOutput)
